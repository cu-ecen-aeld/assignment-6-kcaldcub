...
SRC_URI="git://git@github.com/cu-ecen-aeld/assignments-3-and-later-kcaldcub.git;protocol=ssh;branch=master"
PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
SRCREV = "a596a8ba12db64729ee04afdf14f52bd1aef31d8"
